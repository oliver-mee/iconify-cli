...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"iconify-pp-cli auth login",
		"iconify-pp-cli doctor",
		"iconify-pp-cli help items",
		"iconify-pp-cli sync",
		"iconify-pp-cli profile list",
		"iconify-pp-cli feedback list",
		"iconify-pp-cli which",
		"iconify-pp-cli agent-context",
		"iconify-pp-cli completion bash",
		"iconify-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"iconify-pp-cli recall",
		"iconify-pp-cli learnings",
		"iconify-pp-cli teach-pattern",
		"iconify-pp-cli teach-lookup",
		"iconify-pp-cli items list",
	}
