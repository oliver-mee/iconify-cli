...
large datasets as it has no memory pressure.`,
  ...
  iconify-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  iconify-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  iconify-pp-cli export <resource> --format jsonl | jq '.id'`,
